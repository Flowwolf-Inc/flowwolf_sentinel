...
graph TD
    ...
    subgraph "fw_fluent (Perception)"
        Fluent_Ingest --> |"Normalize to Text"| Normalizer
    end
    
    Fluent_Ingest --> |"Raw Signal"| fw_cortex
    
    subgraph "fw_cortex (Cognition)"
...
### App 1: `fw_cortex` (The Brain & Judge)
...
graph TD
    ...
    subgraph "Feedback Loop"
        fw_motion -- "Override" --> TeacherUI
        TeacherUI -- "New Rule" --> fw_cortex
    end
```
